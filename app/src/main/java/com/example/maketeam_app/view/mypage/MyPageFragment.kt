...
import com.example.maketeam_app.base.BaseAlertDialogCustom
...
class MyPageFragment : Fragment(), DialogInterface {
    ...
    private fun settingAdapter(){
        ...
        val adapter = BoardAdapter(requireContext(), object : ItemClick{
            ...
            override fun clickApplyEnd(id: Long, isEnd: Boolean) {
                this@MyPageFragment.id = id
                this@MyPageFragment.isEnd = isEnd
                BaseAlertDialogCustom(requireContext(), this@MyPageFragment).show()
    ...
    override fun NegativeBtnClicked() {
        Toast.makeText(requireContext(), "모집상태 변경을 취소했어요", Toast.LENGTH_SHORT).show()
    }
}
